...
<head>
    ...
    <title>Blingers Analitycs</title>
                        ...
                        <div class="login_container_formulario">
                            <form class="">
                                ...
                                <div class="input_login my-3">
                                    <input class="form-control" type="email" name="user" placeholder="Usuário">
                                </div>
                                <div class="input_login my-3">
                                    <input class="form-control" type="pass" name="pass" placeholder="Senha">
                                </div>
